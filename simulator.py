...
To point at a deployed server instead of localhost, set an env var:
    ELDERCARE_SERVER=https://your-app.onrender.com/api/sensor-data python simulator.py
...
def play_fall(t):
    ...
    time.sleep(0.2)
    for _ in range(4):
        post(round(normal_hr(t) + 8, 1), still_accel())
        time.sleep(0.4)
